(function () {
  ...
  onReady(() => {
    // target ONLY the aw-signup form
    const form =
      document.querySelector('form[name="aw-signup"]') ||
      document.querySelector('#wf-form-aw-signup');
    if (!form) return;
    ...
    if (!nameInput || !emailInput) {
      console.warn('[aw-signup] Name or Email field missing'); return;
    }
    ...
    form.addEventListener(
      ...
      async (e) => {
        ...
        try {
          const r = await fetch(`${API_BASE}/aw-signup`, {
            method: 'POST',
